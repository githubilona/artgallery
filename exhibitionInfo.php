...
*/
    ...
    ?>
    <button class="tablink" onclick="openPage('Information', this, 'red')">Information</button>
    <button class="tablink" onclick="openPage('Author', this, 'green')" id="defaultOpen">Author</button>
    <button class="tablink" onclick="openPage('Ticket', this, 'blue')">Tickets</button>
        ...
        <div class="split left">
            ...
            <div id="address">
                ...
                <p> <b>Where: </b> <br>
                    ...
                    <?php echo $address['street'] .  ' '. $address['home_number'] . ' '. $address['flat_number']; ?> <br>
                    <?php echo $address['post_code']; ?><br>
                    <?php echo $address['country']; ?>  </p>
            </div>
            <div>
                <button onclick="openPage('Ticket', this, 'blue')">Buy a ticket</button>
            </div>
        </div>
